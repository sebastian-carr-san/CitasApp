...
namespace AppCitas.UnitTests.Pruebas
{
    public class UsersControllerTests
    {
        ...
        [Theory]
        [InlineData("NoContent", "wagner", "Pa$$w0rd", "b.jpeg")]
        ...
        [Theory]
        [InlineData("NoContent", "berry", "Pa$$w0rd","IntroductionU","LookingForU","InterestsU","CityU","CountryU")]
        ...
        [Theory]
        [InlineData("OK", "lisa", "Pa$$w0rd", "c.jpeg")]
        ...
        [Theory]
        [InlineData("Created", "todd", "Pa$$w0rd", "a.jpeg")]
        ...
        [Theory]
        [InlineData("NotFound", "wagner", "Pa$$w0rd", "15")]
